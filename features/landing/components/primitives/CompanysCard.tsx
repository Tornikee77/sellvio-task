...
const CompanysCard: React.FC<CompanyCardProps> = ({
  currentAmount,
  goalAmount,
}) => {
  return (
    <div className="max-w-[446px] h-[454px] bg-transparent rounded-[8px] border border-[#00000036] flex flex-col relative">
      <div className="relative">
        ...
        <div className="absolute top-[19px] left-[19px] rounded-3xl px-3 py-2 font-semibold text-[10px] text-white bg-[#00D5404F]">
          აქტიური
        </div>
      ...
      <div className="flex flex-col px-[22px] mt-4 flex-1">
        ...
        <div>
          <ProgressDash currentAmount={800} goalAmount={1000} />
        </div>
        ...
        <div className="flex justify-between items-center text-[#000000AD] font-medium">
          <p>ჯამური გადახდა</p>
          <p className="text-[#00D540] font-semibold">${currentAmount}</p>
        </div>
